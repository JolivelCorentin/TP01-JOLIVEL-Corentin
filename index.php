...
<div class="col-md-6 col-lg-6" style="margin-top: 4%">
        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="password" class="form-control" id="confirmation" name="confirmation" placeholder="" value="" required>
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
        ...
        <div style="margin-top: 4%">
          <input class="btn-lg btn-primary" type="submit" onclick="VerifyPasswords();">
</div>	
         </form>
     </div>
 </div>
